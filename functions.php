...
function kichijoji_breast_clinic_scripts() {
	...
	wp_enqueue_script( 'kichijoji-breast-clinic-validationEngine-ja', get_template_directory_uri() . '/js/validation/languages/jquery.validationEngine-ja.js', array('jquery'), 1.2, true );
